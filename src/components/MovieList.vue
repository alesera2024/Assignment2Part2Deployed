        ...
        <div class="card" v-for="movie in movies" :key="movie">
          ...
          <div :id="'collapse' + movie.pk" class="collapse" :aria-labelledby="'heading' + movie.pk"
            ...
            <div class="card-body">
              ...
              <p><b>Director:</b> {{ movie.director }}</p> <!-- New Director Field -->
          ...
          <table class="table table-hover" style="overflow-y: auto" :headers="headers">
            <thead>
              <tr>
                ...
                <th scope="col">Director</th> <!-- New Director Column -->
            ...
            <tbody>
              <tr v-for="movie in movies" :key="movie">
                ...
                <td>{{ movie.year }}</td>
                <td>{{ movie.rating }}</td>
                <td>{{ movie.director }}</td> <!-- Display Director -->
    ...
    data() {
      return {
        ...
        headers: [
          ...
          { text: 'Director', sortable: false, align: 'left' }, // Added Director
